...
final class GeminiTokenModelClient implements ModelClientInterface
{
    ...
    public function request(Model $model, array|string $payload, array $options = []): RawHttpResult
    {
        ...
        unset($config['generationConfig']['stream'], $config['generationConfig']['tools'], $config['generationConfig']['tool_config'], $config['generationConfig']['server_tools']);
